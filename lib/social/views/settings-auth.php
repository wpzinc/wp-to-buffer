			...
			<div class="postbox">
				<header>
					...
					<p class="description">
						...
						<br />
						<?php
						echo esc_html__( 'Missing profiles? Click the Refresh Profiles to update your profiles list.', 'wp-to-buffer' );
						?>
						<br />
						<?php
						echo esc_html(
							sprintf(
								...
								__( 'Issues with your connection to %1$s? Click the Reconnect button.', 'wp-to-buffer' ),
								$this->base->plugin->account
							)
						);
						?>
