			...
			<div class="postbox">
				<header>
					...
					<p class="description">
						...
						<br />
						<?php
						echo esc_html__( 'Missing profiles? Click the Refresh Profiles button to update your profiles list.', 'wp-to-buffer' );
						?>
						<br />
						<?php
						echo esc_html(
							sprintf(
								...
								__( 'Issues with your connection to %s? You\'ll see a Reconnect button below, which you can click.', 'wp-to-buffer' ),
								$this->base->plugin->account
							)
						);
						?>
