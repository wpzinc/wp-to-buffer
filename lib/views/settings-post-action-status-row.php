...
<tr class="status sortable<?php echo esc_attr( $key === 0 ? ' first' : '' ); ?>" data-status-index="<?php echo esc_attr( $key ); ?>" data-status='<?php echo wp_json_encode( $status, JSON_HEX_APOS ); ?>' data-labels='<?php echo wp_json_encode( $labels, JSON_HEX_APOS ); ?>'>
	...
	<td class="actions">
		<a href="#" class="dashicons dashicons-move move-status" title="<?php esc_attr_e( 'Reorder Status', 'wpzinc-social' ); ?>"></a>
		<a href="#" class="dashicons dashicons-edit edit-status" title="<?php esc_attr_e( 'Edit Status', 'wpzinc-social' ); ?>"></a>
		<a href="#" class="dashicons dashicons-trash delete-status" title="<?php esc_attr_e( 'Delete Status', 'wpzinc-social' ); ?>"></a>
	</td>
