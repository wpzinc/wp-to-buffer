...
<div class="wpzinc-option highlight">
	<div class="full">
		<h4><?php esc_html_e( 'Want to define different Status for each Social Media Account?', 'wpzinc-social' ); ?></h4>
		...
		<p>
			...
			echo esc_html(
				...
				/* translators: Plugin Name */
					__( '%s Pro allows you to define different statuses for each Social Media Account, with advanced controls for conditional publishing, tags and scheduling.', 'wpzinc-social' ),
