...
= 6.0.6 (2026-06-11) =
* Fix: Settings: Improve performance by using cached organization data
...
= 3.5.7 =
* Fix: Load CRON class for Log Cleanup
...
= 3.5.5 =
* Added: Log: Option to filter Logs by Request Sent Date. See Docs: https://www.wpzinc.com/documentation/wordpress-to-buffer-pro/log-settings/#filtering-logs
* Added: Log: Provide solutions to common issues
* Added: Log: New Log screen with filters and searching to view Status Logs across all Posts for all actions (Publish, Update, Repost, Bulk Publish).  See Docs: https://www.wpzinc.com/documentation/wordpress-to-buffer-pro/logs/
