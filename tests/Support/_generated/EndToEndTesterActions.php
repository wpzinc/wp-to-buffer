...
trait EndToEndTesterActions
{
     ...
     * @see \Tests\Support\Helper\Plugin::activateThirdPartyPlugin()
     */
    public function activateThirdPartyPlugin($I, $name, $wizardExpectsToDisplay = true) {
        return $this->getScenario()->runStep(new \Codeception\Step\Action('activateThirdPartyPlugin', func_get_args()));
    }
	 ...
	 * @param   string         $name   Plugin Slug.
     * @see \Tests\Support\Helper\Plugin::deactivateThirdPartyPlugin()
     */
    public function deactivateThirdPartyPlugin($I, $name) {
        return $this->getScenario()->runStep(new \Codeception\Step\Action('deactivateThirdPartyPlugin', func_get_args()));
    }
	 ...
	 *
	 * @return  bool
     * @see \Tests\Support\Helper\Plugin::amLoggedInAsAdmin()
     */
    public function amLoggedInAsAdmin($I) {
        return $this->getScenario()->runStep(new \Codeception\Step\Condition('amLoggedInAsAdmin', func_get_args()));
    }
	 ...
	 *
	 * @param   EndToEndTester $I      EndToEnd Tester.
     * @see \Tests\Support\Helper\Plugin::doLoginAsAdmin()
     */
    public function doLoginAsAdmin($I) {
        return $this->getScenario()->runStep(new \Codeception\Step\Action('doLoginAsAdmin', func_get_args()));
    }
	 ...
	 *
	 * @param   AcceptanceTester $I  Tester.
     * @see \Tests\Support\Helper\Xdebug::checkNoWarningsAndNoticesOnScreen()
     */
    public function checkNoWarningsAndNoticesOnScreen($I) {
        return $this->getScenario()->runStep(new \Codeception\Step\Action('checkNoWarningsAndNoticesOnScreen', func_get_args()));
    }
}
