...
This document describes the high level workflow used when working on the WP to Buffer WordPress Plugin.

You're free to use your preferred IDE and Git client.

## Prerequisites

If you haven't yet set up your local development environment with the WP to Buffer Plugin repository installed, refer to the [Setup Guide](SETUP.md).
